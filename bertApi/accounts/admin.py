...
class CustomUserAdmin(UserAdmin):
    list_display = ('username', 'email', 'is_staff', 'approvalStatus',"openAIToken")
    fieldsets = (
        (None, {'fields': ('username', 'password')}),
        ('Personal info', {'fields': ('first_name', 'last_name', 'email', 'approvalStatus','totalQueryQuestion','openAIToken')}),
